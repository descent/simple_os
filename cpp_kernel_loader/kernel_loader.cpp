...
int dos_sector_no_to_bios_sector_no(u32 dos_sector_no, u8 *head_no, u8 *track_no, u8 *sector_no)
{
  *track_no = (((dos_sector_no)/18) >> 1);
  *head_no = (((dos_sector_no)/18) & 1);
  *sector_no = (((dos_sector_no)%18) + 1);
  return 0;
}
#endif
